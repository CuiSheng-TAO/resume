...
const TEMPLATE_FAMILY_LIBRARY_DEFINITIONS: CuratedTemplateManifest[] = [
  ...
  {
    version: "v1",
    templateId: "warm-photo-right",
    name: "Warm Photo Right",
    displayName: "形象右置版",
    description: "保留温和的正式感，把头像和基础信息放在右上角更利于第一眼识别。",
    familyId: "warm-professional",
    familyLabel: "温暖专业",
    fitSummary: "适合需要保留照片、又不想让版式太强势的岗位或投递场景。",
    previewHighlights: ["头像区更完整", "信息块更容易一眼看清", "整体气质亲和正式"],
    tone: "calm",
    page: {
      size: "A4",
      marginPreset: "balanced",
