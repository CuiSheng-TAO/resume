...
const TEMPLATE_FAMILY_LIBRARY_DEFINITIONS: CuratedTemplateManifest[] = [
  ...
  },
  {
    ...
    displayName: "教育先读版",
    description: "先把学校、专业和学业亮点摆出来，适合先建立可信度。",
    familyId: "warm-professional",
    familyLabel: TEMPLATE_FAMILY_LABELS["warm-professional"],
  ...
  },
  {
    ...
    displayName: "经历先读版",
    description: "把实习与项目放到前面，适合已经有成型经历的人。",
    familyId: "warm-professional",
    familyLabel: TEMPLATE_FAMILY_LABELS["warm-professional"],
  ...
  },
  {
    ...
    displayName: "档案卡片版",
    description: "把个人信息收成顶部档案卡，更适合想让抬头区更完整又更有区分度的简历。",
    familyId: "warm-professional",
    familyLabel: TEMPLATE_FAMILY_LABELS["warm-professional"],
  ...
  },
  {
    ...
    displayName: "学术台账版",
    description: "像台账一样清楚列出教育、研究和奖项，整体更理性克制。",
  ...
  },
  {
    ...
    displayName: "学术信号版",
    description: "把成绩、排名、研究方向等信号拆成更好扫读的小块。",
    familyId: "calm-academic",
    familyLabel: TEMPLATE_FAMILY_LABELS["calm-academic"],
  ...
  },
  {
    ...
    displayName: "学术时间线版",
    description: "更强调阶段推进与角色变化，适合研究、课题和项目经历较长的人。",
    familyId: "calm-academic",
    familyLabel: TEMPLATE_FAMILY_LABELS["calm-academic"],
  ...
  },
  {
    ...
    displayName: "学术紧凑版",
    description: "把学术风格压得更紧一些，适合内容多但仍想保持冷静秩序。",
    familyId: "calm-academic",
    familyLabel: TEMPLATE_FAMILY_LABELS["calm-academic"],
  ...
  },
  {
    ...
    displayName: "紧凑清晰",
    description: "把信息压得更紧，但仍保持现代、干净和易读。",
  ...
  },
  {
    ...
    displayName: "现代平衡版",
    description: "把重点和秩序压到一个更均衡的位置，适合综合型候选人。",
    familyId: "modern-clean",
    familyLabel: TEMPLATE_FAMILY_LABELS["modern-clean"],
  ...
  },
  {
    ...
    name: "Modern Minimal",
    displayName: "现代极简版",
    description: "把装饰和说明都减到更少，适合用最少干扰传达核心事实。",
    familyId: "modern-clean",
    familyLabel: TEMPLATE_FAMILY_LABELS["modern-clean"],
  ...
  },
  {
    ...
    name: "Classic Banner",
    displayName: "重点突出",
    description: "顶部识别很强，适合把亮点和结果尽快抬到上半页。",
  ...
  },
  {
    ...
    displayName: "指标亮点版",
    description: "把量化结果、增长指标和项目成效抬得更靠前，更适合结果导向岗位。",
    familyId: "highlight-forward",
    familyLabel: TEMPLATE_FAMILY_LABELS["highlight-forward"],
  ...
  },
  {
    ...
    displayName: "顶部重点版",
    description: "把技能和个人卖点堆成上半页的重点区，适合需要先抢注意力的岗位。",
    familyId: "highlight-forward",
    familyLabel: TEMPLATE_FAMILY_LABELS["highlight-forward"],
